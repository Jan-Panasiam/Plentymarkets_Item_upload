...
NUITKA_LOCAL_MODULE PyObject *impl___internal__$$$function_4_get_callable_name_desc( PyObject **python_pars );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_1__unpack_list( PyObject **python_pars )
{
    ...
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_1__unpack_list );
    return NULL;
    // Return handler code:
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_2__mro_entries_conversion( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_2__mro_entries_conversion );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_6_complex_call_helper_star_list_star_dict( PyObject **python_pars )
{
...

        {
            ...
            branch_yes_2:;
            {
...

                {
                    ...
                    tmp_tuple_element_1 = impl___internal__$$$function_4_get_callable_name_desc( dir_call_args );
                }
...

    {
        ...
        branch_yes_3:;
        {
            ...
            tmp_res = PyObject_HasAttr( tmp_source_name_2, const_str_plain___iter__ );
            ...
            or_right_1:;
            CHECK_OBJECT( par_star_arg_list );
            tmp_source_name_3 = par_star_arg_list;
            ...
            branch_no_4:;
            {
...

                {
                    ...
                    tmp_tuple_element_2 = impl___internal__$$$function_4_get_callable_name_desc( dir_call_args );
                }
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_6_complex_call_helper_star_list_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
...
NUITKA_LOCAL_MODULE PyObject *impl___internal__$$$function_4_get_callable_name_desc( PyObject **python_pars )
{
    ...
    // Return statement must have exited already.
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_4_get_callable_name_desc );
    return NULL;
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_8_complex_call_helper_pos_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_8_complex_call_helper_pos_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_9_complex_call_helper_pos_star_list_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_9_complex_call_helper_pos_star_list_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
            ...
            }
            {
                ...
                branch_yes_5:;
                {
...

                    {
                        ...
                        tmp_tuple_element_3 = impl___internal__$$$function_4_get_callable_name_desc( dir_call_args );
                    }
...
NUITKA_CROSS_MODULE PyObject *impl___internal__$$$function_10_complex_call_helper_star_dict( PyObject **python_pars )
{
    ...
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( __internal__$$$function_10_complex_call_helper_star_dict );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    CHECK_OBJECT( (PyObject *)par_called );
