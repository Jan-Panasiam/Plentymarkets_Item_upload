...
/* The "_module_dbus$types" is a Python object pointer of module type.
 *
...
static PyObject *const_str_digest_1fb636284d1dc24661eb9fc5aac76a76;
...
static PyCodeObject *codeobj_1adf4263eda07e431174fcc04407385b;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_1fb636284d1dc24661eb9fc5aac76a76 );
    codeobj_1adf4263eda07e431174fcc04407385b = MAKE_CODEOBJ( module_filename_obj, const_str_digest_bee3442881305db322ec1ee71f49c522, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
static struct PyModuleDef mdef_dbus$types =
{
...
MOD_INIT_DECL( dbus$types )
{
    ...
    if ( _init_done )
    {
        return MOD_RETURN_VALUE( module_dbus$types );
    }
    else
    {
        _init_done = true;
...
#ifdef _NUITKA_TRACE
    puts("dbus.types: Calling setupMetaPathBasedLoader().");
#endif
...
#ifdef _NUITKA_TRACE
    puts("dbus.types: Calling createModuleConstants().");
#endif
    createModuleConstants();

    /* The code objects used by this module are created now. */
#ifdef _NUITKA_TRACE
    puts("dbus.types: Calling createModuleCodeObjects().");
#endif
    createModuleCodeObjects();

    // puts( "in initdbus$types" );
    ...
    // use for it.
#if PYTHON_VERSION < 300
    module_dbus$types = Py_InitModule4(
        "dbus.types",       // Module Name
    ...
    module_dbus$types = PyModule_Create( &mdef_dbus$types );
#endif
...
#if PYTHON_VERSION >= 300
    {
        int r = PyObject_SetItem( PyImport_GetModuleDict(), const_str_digest_1abd3647207b34d013514bc0c6956d0b, module_dbus$types );
...
// Set the "__spec__" value
    ...
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        PyObject *args[] = {
            GET_STRING_DICT_VALUE( moduledict_dbus$types, (Nuitka_StringObject *)const_str_plain___name__ ),
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_1adf4263eda07e431174fcc04407385b;
    ...
    // Frame without reuse.
    frame_1adf4263eda07e431174fcc04407385b = MAKE_MODULE_FRAME( codeobj_1adf4263eda07e431174fcc04407385b, module_dbus$types );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_1adf4263eda07e431174fcc04407385b );
    assert( Py_REFCNT( frame_1adf4263eda07e431174fcc04407385b ) == 2 );
    ...
    }
    {
        ...
        frame_1adf4263eda07e431174fcc04407385b->m_frame.f_lineno = 6;
...

    {
        ...
        frame_1adf4263eda07e431174fcc04407385b->m_frame.f_lineno = 11;
    ...
    }
    {
        ...
        branch_yes_1:;
        {
            ...
            frame_1adf4263eda07e431174fcc04407385b->m_frame.f_lineno = 13;
        ...
        }
        {
            ...
            frame_1adf4263eda07e431174fcc04407385b->m_frame.f_lineno = 14;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_1adf4263eda07e431174fcc04407385b );
#endif
    popFrameStack();

    assertFrameObject( frame_1adf4263eda07e431174fcc04407385b );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_1adf4263eda07e431174fcc04407385b, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_1adf4263eda07e431174fcc04407385b->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_1adf4263eda07e431174fcc04407385b, exception_lineno );
    }
...
#if 0 && 0
    {
        PyObject *path_value = GET_STRING_DICT_VALUE( moduledict_dbus$types, (Nuitka_StringObject *)const_str_plain___path__ );
